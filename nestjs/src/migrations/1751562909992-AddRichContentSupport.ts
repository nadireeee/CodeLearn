...
export class AddRichContentSupport1751562909992 implements MigrationInterface {
    name = 'AddRichContentSupport1751562909992'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "answers" ADD "images" text`);
